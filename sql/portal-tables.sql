...
create table mbthread_addon (
	thread_id LONG not null primary key,
	date_from DATE null,
	date_to DATE null,
	discussion_area VARCHAR(75) null,
	territory VARCHAR(75) null
);

create table mz_mbthread_addon (
	thread_id LONG not null primary key,
	date_from DATE null,
	date_to DATE null,
	discussion_area VARCHAR(75) null,
...
create table mz_thread_detail (
	rootmessageid LONG not null primary key,
	username VARCHAR(75) null,
	subject VARCHAR(75) null,
	date_from DATE null,
	date_to DATE null,
...
create table mz_user_addon (
	userid LONG not null primary key,
	phone VARCHAR(75) null,
	companyposition VARCHAR(75) null,
	organizationid LONG,
	notify BOOLEAN,
