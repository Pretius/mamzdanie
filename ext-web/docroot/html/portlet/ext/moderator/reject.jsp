...
<div><h1 style="color: #AE4A4A;">Do zatwierdzenia przez moderatora:</h1></div>
...
<div class="common_container">
	...
	<form
	id="rejectForm"
	action="<portlet:actionURL><portlet:param name="struts_action" value="/p/moderator/view" /><portlet:param name="<%= Constants.CMD %>" value="<%=submitCmd%>" /><portlet:param name="messageId" value="<%= String.valueOf(message.getMessageId()) %>" /></portlet:actionURL>"
	enctype="multipart/form-data" method="post">
		<div class="rejectOrInactive_textarea_message">
			<liferay-ui:message key="moderator.message.reject.info"/>&nbsp;<%=message.getUserName()%>
		</div>
			...
			<div class="big_button menu_button green">
				...
				<div class="middle">
					<a href="#"
						...
						<liferay-ui:message key="moderator.action.reject"/>
					</a>
				</div>
				<div class="right"></div>
			</div>
