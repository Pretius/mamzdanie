...
<%
	...
	messageAddonCriteria.add(Restrictions.eq("status", MBMessageStatusType.NEW_MESSAGE.name()));
...
<div>
	<h1 style="color: #AE4A4A;"><liferay-ui:message key="moderator.view.grid.reject.title" /></h1>
</div>
...
<%
	for (MBMessageAddon messageAddon : messageAddons) {
		...
		String rejectMessageUrl = "/web/guest/moderator" +
				"?p_p_id=moderator" + "&" +
				"p_p_lifecycle=0" + "&" +
				"p_p_state=normal" + "&" +
				"p_p_mode=view" + "&" +
		...
		String approveMessageUrl = "/web/guest/moderator" +
				"?p_p_id=moderator" + "&" +
				"p_p_lifecycle=0" + "&" +
				"p_p_state=normal" + "&" +
				"p_p_mode=view" + "&" +
...
%>
	<tr>
		...
		<td>
			...
			<a href="<%=rejectMessageUrl%>">
				<liferay-ui:message key="moderator.action.reject"/>&nbsp;
			</a>
			<a href="<%=approveMessageUrl%>">
				<liferay-ui:message key="moderator.action.approve"/>
			</a>
		</td>
	</tr>
<%
